...
class RuleTester extends TestFramework_1.TestFramework {
    ...
    runRuleForItem(ruleName, rule, item) {
        ...
        do {
            passNumber++;
            const { applyInlineConfig, applyLanguageOptions, finalize } = eslint_1.SourceCode.prototype;
            try {
                forbiddenMethods.forEach(methodName => {
                    eslint_1.SourceCode.prototype[methodName] = throwForbiddenMethodError(methodName, eslint_1.SourceCode.prototype);
                });
                ...
                eslint_1.SourceCode.prototype.applyInlineConfig = applyInlineConfig;
                eslint_1.SourceCode.prototype.applyLanguageOptions = applyLanguageOptions;
                eslint_1.SourceCode.prototype.finalize = finalize;
            }
